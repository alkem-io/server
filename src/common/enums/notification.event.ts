...
export enum NotificationEvent {
  ...
  // Space notifications
  SPACE_COMMUNITY_APPLICATION_ADMIN = 'space-communityApplicationAdmin',
  ...
  SPACE_COMMUNICATION_MESSAGE_RECIPIENT = 'space-communicationMessageRecipient',
  SPACE_COMMUNICATION_MESSAGE_SENDER = 'space-communicationMessageSender',
  SPACE_COMMUNICATION_UPDATE = 'space-communicationUpdate',
  SPACE_COMMUNICATION_UPDATE_ADMIN = 'space-communicationUpdateAdmin',
  SPACE_COLLABORATION_POST_CREATED_ADMIN = 'space-collaborationPostCreatedAdmin',
  SPACE_COLLABORATION_POST_CREATED = 'space-collaborationPostCreated',
  SPACE_COLLABORATION_POST_COMMENT_CREATED = 'space-collaborationPostCommentCreated',
  SPACE_COLLABORATION_WHITEBOARD_CREATED = 'space-collaborationWhiteboardCreated',
  SPACE_COLLABORATION_CALLOUT_PUBLISHED = 'space-collaborationCalloutPublished',
