export enum AlkemioErrorStatus {
  ...
  ROLE_SET_OPEN_APPLICATION_EXISTS = 'ROLESET_OPEN_APPLICATION_EXISTS',
  ROLE_SET_OPEN_INVITATION_EXISTS = 'ROLESET_OPEN_INVITATION_EXISTS',
  ROLE_SET_ALREADY_MEMBER = 'ROLESET_ALREADY_MEMBER',
