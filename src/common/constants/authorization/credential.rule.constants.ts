...
export const CREDENTIAL_RULE_ACCOUNT_ADMIN_MANAGE =
  'credentialRule-accountAdminManage';
...
export const CREDENTIAL_RULE_ORGANIZATION_ADMIN =
  'credentialRule-organizationAdmin';
export const CREDENTIAL_RULE_ORGANIZATION_READ =
  'credentialRule-organizationRead';
...
export const CREDENTIAL_RULE_COLLABORA_DOCUMENT_CREATED_BY =
  'credentialRule-collaboraDocumentCreatedBy';
