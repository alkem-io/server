...
import aadConfig from '@src/core/config/aad.config';
...
import serviceConfig from '@src/core/config/service.config';
import { BootstrapModule } from '@src/common/bootstrap/bootstrap.module';
import msGraphConfig from '@src/core/config/ms-graph.config';
import { WinstonModule } from 'nest-winston';
import aadClientConfig from '@src/core/config/aad.client.config';
import { WinstonConfigService } from '@src/core/config/winston.config';
import loggingConfig from '@src/core/config/logging.config';
...
import aadRopcConfig from '@src/core/config/aad.ropc.config';
...
import aadOboConfig from '@src/core/config/aad.obo.config';
...
import simpleAuthProviderConfig from '@src/core/config/simple.auth.provider.config';
