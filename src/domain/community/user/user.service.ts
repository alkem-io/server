    ...
    const settings: CreateUserSettingsInput = {
      ...
      notification: {
        ...
        space: {
          ...
          adminCommunicationMessage: true,
          adminCollaborationCalloutContribution: true,
          collaborationContributionCreated: true,
          collaborationCalloutContributionComment: true,
