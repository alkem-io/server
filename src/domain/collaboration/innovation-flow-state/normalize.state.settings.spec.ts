...
describe('normalizeStateSettings — sidebar', () => {
  it('defaults sidebar to [INTENT, INDEX] when the key is missing on an existing settings object', () => {
  ...
  it('defaults sidebar to [INTENT, INDEX] when settings is entirely absent', () => {
