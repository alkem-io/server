...
import { SpaceDefaultsCreateCalloutInput } from '../../dto/space.defaults.dto.create.callout.input';

export const spaceDefaultsCalloutsOpportunity: SpaceDefaultsCreateCalloutInput[] =
  [
    {
      nameID: 'general-chat',
    ...
    },
    {
      ...
      framing: {
        profile: {
          ...
          description:
            'Please add links to documents with reference material.💥',
        },
      },
    },
    {
