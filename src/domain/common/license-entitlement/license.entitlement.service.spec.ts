...
describe('LicenseEntitlementService', () => {
  ...
  let entitlementRepository: MockType<Repository<LicenseEntitlement>>;
  ...
  beforeEach(async () => {
    const module: TestingModule = await Test.createTestingModule({
      providers: [
        ...
        repositoryProviderMockFactory(LicenseEntitlement),
        MockCacheManager,
        MockWinstonProvider,
      ],
    })
    ...
    entitlementRepository = module.get(getRepositoryToken(LicenseEntitlement));
  ...
  describe('deleteEntitlementOrFail', () => {
    it('should remove entitlement and preserve original id', async () => {
      ...
      entitlementRepository.findOne!.mockResolvedValue(entitlement);
      entitlementRepository.remove!.mockResolvedValue({ limit: 5 });
