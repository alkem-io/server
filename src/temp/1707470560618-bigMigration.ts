...
export class bigMigration1707470560618 implements MigrationInterface {
  name = 'bigMigration1707470560618';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query('ALTER TABLE `challenge` DROP COLUMN `spaceId`');
    await queryRunner.query(
    ...
    await queryRunner.query('ALTER TABLE `profile` ADD `tagline` text NULL');
    await queryRunner.query(
    ...
    await queryRunner.query('ALTER TABLE `user_group` DROP COLUMN `spaceID`');
    await queryRunner.query(
    ...
    await queryRunner.query('ALTER TABLE `application` DROP COLUMN `spaceID`');
    await queryRunner.query(
    ...
    await queryRunner.query('ALTER TABLE `community` DROP COLUMN `spaceID`');
    await queryRunner.query(
    ...
    await queryRunner.query('ALTER TABLE `innovation_flow` DROP COLUMN `type`');
    await queryRunner.query(
    ...
    await queryRunner.query('ALTER TABLE `opportunity` DROP COLUMN `nameID`');
    await queryRunner.query(
      'ALTER TABLE `opportunity` ADD `nameID` varchar(255) NOT NULL'
    );
    await queryRunner.query('ALTER TABLE `opportunity` DROP COLUMN `spaceID`');
    await queryRunner.query(
    ...
    await queryRunner.query(
      'CREATE UNIQUE INDEX `REL_0af5c8e5c0a2f7858ae0a40c04` ON `innovation_flow` (`lifecycleId`)'
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      'ALTER TABLE `innovation_flow` DROP INDEX `IDX_0af5c8e5c0a2f7858ae0a40c04`'
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      'ALTER TABLE `calendar_event` ADD `createdBy` char(36) NULL'
    );
    await queryRunner.query('ALTER TABLE `calendar_event` DROP COLUMN `type`');
    await queryRunner.query(
    ...
    await queryRunner.query('ALTER TABLE `document` DROP COLUMN `createdBy`');
    await queryRunner.query(
      'ALTER TABLE `document` ADD `createdBy` char(36) NULL'
    );
    await queryRunner.query('ALTER TABLE `location` DROP COLUMN `postalCode`');
    await queryRunner.query(
    ...
    await queryRunner.query(
      'CREATE INDEX `IDX_8bc0e1f40be5816d3a593cbf7f` ON `callout_framing` (`whiteboardId`)'
    );
    await queryRunner.query(
