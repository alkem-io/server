...
export class SchemaSetup1730713372181 implements MigrationInterface {
  name = 'SchemaSetup1730713372181';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      'CREATE TABLE `collaboration` (`id` char(36) NOT NULL, `createdDate` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), `updatedDate` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), `version` int NOT NULL, `isTemplate` tinyint NOT NULL DEFAULT 0, `groupsStr` text NOT NULL, `authorizationId` char(36) NULL, `tagsetTemplateSetId` char(36) NULL, `timelineId` char(36) NULL, `innovationFlowId` char(36) NULL, UNIQUE INDEX `REL_262ecf3f5d70b82a4833618425` (`authorizationId`), UNIQUE INDEX `REL_b7ece56376ac7ca0b9a56c33b3` (`tagsetTemplateSetId`), UNIQUE INDEX `REL_f67a2d25c945269d602c182fbc` (`timelineId`), UNIQUE INDEX `REL_35c6b1de6d4d89dfe8e9c85d77` (`innovationFlowId`), PRIMARY KEY (`id`)) ENGINE=InnoDB'
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      'CREATE TABLE `role_set` (`id` char(36) NOT NULL, `createdDate` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), `updatedDate` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), `version` int NOT NULL, `entryRole` varchar(128) NOT NULL, `authorizationId` char(36) NULL, `applicationFormId` char(36) NULL, `parentRoleSetId` char(36) NULL, UNIQUE INDEX `REL_b038f74c8d4eadb839e78b99ce` (`authorizationId`), UNIQUE INDEX `REL_00905b142498f63e76d38fb254` (`applicationFormId`), PRIMARY KEY (`id`)) ENGINE=InnoDB'
    );
    await queryRunner.query(
