...
export class Baseline1764590884532 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "credential" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "createdDate" TIMESTAMP NOT NULL DEFAULT now(), "updatedDate" TIMESTAMP NOT NULL DEFAULT now(), "version" integer NOT NULL, "resourceID" character varying(36) NOT NULL, "type" character varying(128) NOT NULL, "issuer" uuid, "expires" TIMESTAMP, "actorId" uuid, CONSTRAINT "PK_3a5169bcd3d5463cefeec78be82" PRIMARY KEY ("id"))`
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE "invitation" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "createdDate" TIMESTAMP NOT NULL DEFAULT now(), "updatedDate" TIMESTAMP NOT NULL DEFAULT now(), "version" integer NOT NULL, "invitedContributorID" uuid NOT NULL, "createdBy" uuid NOT NULL, "welcomeMessage" character varying(8192), "invitedToParent" boolean NOT NULL DEFAULT false, "actorType" character varying(128) NOT NULL, "extraRoles" text NOT NULL, "authorizationId" uuid, "lifecycleId" uuid, "roleSetId" uuid, CONSTRAINT "REL_b132226941570cb650a4023d49" UNIQUE ("authorizationId"), CONSTRAINT "REL_b0c80ccf319a1c7a7af12b3998" UNIQUE ("lifecycleId"), CONSTRAINT "PK_beb994737756c0f18a1c1f8669c" PRIMARY KEY ("id"))`
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE "organization" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "createdDate" TIMESTAMP NOT NULL DEFAULT now(), "updatedDate" TIMESTAMP NOT NULL DEFAULT now(), "version" integer NOT NULL, "nameID" character varying(36) NOT NULL, "communicationID" character varying NOT NULL, "accountID" uuid NOT NULL, "settings" json NOT NULL, "rowId" SERIAL NOT NULL, "legalEntityName" character varying NOT NULL, "domain" character varying NOT NULL, "website" character varying NOT NULL, "contactEmail" character varying NOT NULL, "authorizationId" uuid, "profileId" uuid, "actorId" uuid, "verificationId" uuid, "storageAggregatorId" uuid, "roleSetId" uuid, CONSTRAINT "UQ_d11fdb37a7b736d053b762b27c9" UNIQUE ("nameID"), CONSTRAINT "UQ_9fdd8f0bfe04a676822c7265e17" UNIQUE ("rowId"), CONSTRAINT "REL_e0e150e4f11d906b931b46a2d8" UNIQUE ("authorizationId"), CONSTRAINT "REL_d2cb77c14644156ec8e865608e" UNIQUE ("profileId"), CONSTRAINT "REL_7f1bec8979b57ed7ebd392a2ca" UNIQUE ("actorId"), CONSTRAINT "REL_5a72d5b37312bac2e0a0115718" UNIQUE ("verificationId"), CONSTRAINT "REL_395aa74996a1f978b4969d114b" UNIQUE ("storageAggregatorId"), CONSTRAINT "REL_857684833bbd26eff72f97bcfd" UNIQUE ("roleSetId"), CONSTRAINT "PK_472c1f99a32def1b0abb219cd67" PRIMARY KEY ("id"))`
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE "space" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "createdDate" TIMESTAMP NOT NULL DEFAULT now(), "updatedDate" TIMESTAMP NOT NULL DEFAULT now(), "version" integer NOT NULL, "nameID" character varying(36) NOT NULL, "rowId" SERIAL NOT NULL, "settings" json NOT NULL, "platformRolesAccess" json NOT NULL, "levelZeroSpaceID" uuid, "level" integer NOT NULL, "visibility" character varying(128) NOT NULL, "authorizationId" uuid, "parentSpaceId" uuid, "accountId" uuid, "collaborationId" uuid, "aboutId" uuid, "communityId" uuid, "actorId" uuid, "storageAggregatorId" uuid, "templatesManagerId" uuid, "licenseId" uuid, CONSTRAINT "UQ_0f03c61020ea0dfa0198c60304d" UNIQUE ("rowId"), CONSTRAINT "REL_8d03fd2c8e8411ec9192c79cd9" UNIQUE ("authorizationId"), CONSTRAINT "REL_ea06eb8894469a0f262d929bf0" UNIQUE ("collaborationId"), CONSTRAINT "REL_c59c1beb254808dd32007de661" UNIQUE ("aboutId"), CONSTRAINT "REL_68fa2c2b00cc1ed77e7c225e8b" UNIQUE ("communityId"), CONSTRAINT "REL_9c664d684f987a735678b0ba82" UNIQUE ("actorId"), CONSTRAINT "REL_980c4643d7d9de1b97bc39f518" UNIQUE ("storageAggregatorId"), CONSTRAINT "REL_dea52ce918df6950019678fa35" UNIQUE ("templatesManagerId"), CONSTRAINT "REL_3ef80ef55ba1a1d45e625ea838" UNIQUE ("licenseId"), CONSTRAINT "PK_094f5ec727fe052956a11623640" PRIMARY KEY ("id"))`
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE "account" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "createdDate" TIMESTAMP NOT NULL DEFAULT now(), "updatedDate" TIMESTAMP NOT NULL DEFAULT now(), "version" integer NOT NULL, "type" character varying(128), "externalSubscriptionID" character varying(128), "baselineLicensePlan" json NOT NULL, "authorizationId" uuid, "actorId" uuid, "licenseId" uuid, "storageAggregatorId" uuid, CONSTRAINT "REL_91a165c1091a6959cc19d52239" UNIQUE ("authorizationId"), CONSTRAINT "REL_833582df0c439ab8c9adc5240d" UNIQUE ("actorId"), CONSTRAINT "REL_8339e62882f239dc00ff5866f8" UNIQUE ("licenseId"), CONSTRAINT "REL_950221e932175dc7cf7c006488" UNIQUE ("storageAggregatorId"), CONSTRAINT "PK_54115ee388cdb6d86bb4bf5b2ea" PRIMARY KEY ("id"))`
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "credential" ADD CONSTRAINT "FK_dbe0929355f82e5995f0b7fd5e2" FOREIGN KEY ("actorId") REFERENCES "agent"("id") ON DELETE CASCADE ON UPDATE NO ACTION`
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "user" ADD CONSTRAINT "FK_b61c694cacfab25533bd23d9add" FOREIGN KEY ("actorId") REFERENCES "agent"("id") ON DELETE SET NULL ON UPDATE NO ACTION`
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "organization" ADD CONSTRAINT "FK_7f1bec8979b57ed7ebd392a2ca9" FOREIGN KEY ("actorId") REFERENCES "agent"("id") ON DELETE SET NULL ON UPDATE NO ACTION`
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "space" ADD CONSTRAINT "FK_9c664d684f987a735678b0ba825" FOREIGN KEY ("actorId") REFERENCES "agent"("id") ON DELETE SET NULL ON UPDATE NO ACTION`
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "virtual_contributor" ADD CONSTRAINT "FK_a8890dcd65b8c3ee6e160d33f3a" FOREIGN KEY ("actorId") REFERENCES "agent"("id") ON DELETE SET NULL ON UPDATE NO ACTION`
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "account" ADD CONSTRAINT "FK_833582df0c439ab8c9adc5240d1" FOREIGN KEY ("actorId") REFERENCES "agent"("id") ON DELETE SET NULL ON UPDATE NO ACTION`
    );
    await queryRunner.query(
