...
export class ConverganceOriginal1724418063806 implements MigrationInterface {
    name = 'ConverganceOriginal1724418063806'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`DROP INDEX \`FK_9ad35130cde781b69259eec7d85\` ON \`tagset_template\``);
        await queryRunner.query(`DROP INDEX \`FK_7ab35130cde781b69259eec7d85\` ON \`tagset\``);
        await queryRunner.query(`DROP INDEX \`FK_77771450cf75dc486700ca034c6\` ON \`visual\``);
        await queryRunner.query(`DROP INDEX \`FK_11155450cf75dc486700ca034c6\` ON \`document\``);
        await queryRunner.query(`DROP INDEX \`FK_3337f26ca267009fcf514e0e726\` ON \`document\``);
        await queryRunner.query(`DROP INDEX \`FK_1ba25e7d3dc29fa02b88e17fca0\` ON \`vc_interaction\``);
        await queryRunner.query(`DROP INDEX \`FK_67663901817dd09d5906537e088\` ON \`post\``);
        ...
        await queryRunner.query(`DROP INDEX \`FK_6a30f26ca267009fcf514e0e726\` ON \`calendar_event\``);
        await queryRunner.query(`DROP INDEX \`FK_77755450cf75dc486700ca034c6\` ON \`calendar_event\``);
        ...
        await queryRunner.query(`DROP INDEX \`FK_650fb4e564a8b4b4ac344270744\` ON \`preference\``);
        await queryRunner.query(`DROP INDEX \`FK_88881fbd1fef95a0540f7e7d1e2\` ON \`preference\``);
        ...
        await queryRunner.query(`DROP INDEX \`FK_3334d59c0b805c9c1ecb0070e16\` ON \`organization\``);
        ...
        await queryRunner.query(`DROP INDEX \`FK_2b8381df8c3a1680f50e4bc2351\` ON \`user_group\``);
        await queryRunner.query(`DROP INDEX \`FK_4444d59c0b805c9c1ecb0070e16\` ON \`user\``);
        ...
        await queryRunner.query(`DROP INDEX \`FK_339c1fe2a9c5caef5b982303fb0\` ON \`invitation\``);
        ...
        await queryRunner.query(`DROP INDEX \`FK_42becb5fd6dc563f51ecb71abcc\` ON \`license_plan\``);
        ...
        await queryRunner.query(`DROP INDEX \`FK_2a985f774bd4de2a9aead6bd5b1\` ON \`platform_invitation\``);
        ...
        await queryRunner.query(`DROP INDEX \`FK_59991450cf75dc486700ca034c6\` ON \`post_template\``);
        await queryRunner.query(`DROP INDEX \`FK_66666450cf75dc486700ca034c6\` ON \`post_template\``);
        ...
        await queryRunner.query(`DROP INDEX \`FK_65556450cf75dc486700ca034c6\` ON \`whiteboard_template\``);
        await queryRunner.query(`DROP INDEX \`FK_69991450cf75dc486700ca034c6\` ON \`whiteboard_template\``);
        ...
        await queryRunner.query(`DROP INDEX \`FK_76546450cf75dc486700ca034c6\` ON \`innovation_flow_template\``);
        ...
        await queryRunner.query(`DROP INDEX \`FK_1114d59c0b805c9c1ecb0070e16\` ON \`space\``);
        await queryRunner.query(`DROP INDEX \`FK_71231450cf75dc486700ca034c6\` ON \`space\``);
        await queryRunner.query(`DROP INDEX \`IDX_43559aeadc1a5169d17e81b3d4\` ON \`space\``);
        ...
        await queryRunner.query(`DROP INDEX \`IDX_6b1efee39d076d9f7ecb8fef4c\` ON \`space\``);
        ...
        await queryRunner.query(`DROP INDEX \`FK_77777450cf75dc486700ca034c6\` ON \`innovation_pack\``);
        await queryRunner.query(`DROP INDEX \`REL_22222ccdda9ba57d8e3a634cd8\` ON \`innovation_pack\``);
        await queryRunner.query(`DROP INDEX \`FK_99998853c1ee793f61bda7eff79\` ON \`account\``);
        ...
        await queryRunner.query(`DROP INDEX \`REL_156fd30246eb151b9d17716abf\` ON \`innovation_hub\``);
        ...
        await queryRunner.query(`ALTER TABLE \`tagset_template\` ADD \`name\` varchar(128) NOT NULL`);
        await queryRunner.query(`ALTER TABLE \`tagset_template\` DROP COLUMN \`type\``);
        await queryRunner.query(`ALTER TABLE \`tagset_template\` ADD \`type\` varchar(128) NOT NULL`);
        ...
        await queryRunner.query(`ALTER TABLE \`tagset\` ADD \`type\` varchar(128) NOT NULL`);
        await queryRunner.query(`ALTER TABLE \`visual\` DROP COLUMN \`uri\``);
        await queryRunner.query(`ALTER TABLE \`visual\` ADD \`uri\` varchar(2048) NOT NULL`);
        ...
        await queryRunner.query(`ALTER TABLE \`location\` ADD \`city\` varchar(128) NULL`);
        await queryRunner.query(`ALTER TABLE \`location\` DROP COLUMN \`country\``);
        await queryRunner.query(`ALTER TABLE \`location\` ADD \`country\` varchar(128) NULL`);
        await queryRunner.query(`ALTER TABLE \`location\` DROP COLUMN \`addressLine1\``);
        await queryRunner.query(`ALTER TABLE \`location\` ADD \`addressLine1\` varchar(512) NULL`);
        await queryRunner.query(`ALTER TABLE \`location\` DROP COLUMN \`addressLine2\``);
        await queryRunner.query(`ALTER TABLE \`location\` ADD \`addressLine2\` varchar(512) NULL`);
        await queryRunner.query(`ALTER TABLE \`location\` CHANGE \`stateOrProvince\` \`stateOrProvince\` varchar(128) NULL`);
        await queryRunner.query(`ALTER TABLE \`location\` CHANGE \`postalCode\` \`postalCode\` varchar(128) NULL`);
        await queryRunner.query(`ALTER TABLE \`document\` CHANGE \`createdBy\` \`createdBy\` char(36) NOT NULL`);
        await queryRunner.query(`ALTER TABLE \`document\` DROP COLUMN \`displayName\``);
        await queryRunner.query(`ALTER TABLE \`document\` ADD \`displayName\` varchar(512) NOT NULL`);
        await queryRunner.query(`ALTER TABLE \`document\` CHANGE \`mimeType\` \`mimeType\` varchar(128) NOT NULL`);
        await queryRunner.query(`ALTER TABLE \`document\` CHANGE \`size\` \`size\` int NOT NULL`);
        await queryRunner.query(`ALTER TABLE \`document\` CHANGE \`externalID\` \`externalID\` varchar(128) NOT NULL`);
        ...
        await queryRunner.query(`ALTER TABLE \`profile\` ADD \`type\` varchar(128) NOT NULL`);
        ...
        await queryRunner.query(`ALTER TABLE \`vc_interaction\` ADD \`threadID\` varchar(44) NOT NULL`);
        await queryRunner.query(`ALTER TABLE \`room\` DROP COLUMN \`type\``);
        await queryRunner.query(`ALTER TABLE \`room\` ADD \`type\` varchar(128) NOT NULL`);
        ...
        await queryRunner.query(`ALTER TABLE \`whiteboard\` ADD \`nameID\` varchar(36) NOT NULL`);
        await queryRunner.query(`ALTER TABLE \`whiteboard\` DROP COLUMN \`contentUpdatePolicy\``);
        await queryRunner.query(`ALTER TABLE \`whiteboard\` ADD \`contentUpdatePolicy\` varchar(128) NOT NULL`);
        ...
        await queryRunner.query(`ALTER TABLE \`callout_contribution_policy\` ADD \`state\` varchar(128) NOT NULL`);
        await queryRunner.query(`ALTER TABLE \`post\` DROP COLUMN \`type\``);
        await queryRunner.query(`ALTER TABLE \`post\` ADD \`type\` varchar(128) NOT NULL`);
        await queryRunner.query(`ALTER TABLE \`post\` CHANGE \`createdBy\` \`createdBy\` char(36) NOT NULL`);
        ...
        await queryRunner.query(`ALTER TABLE \`callout_contribution\` CHANGE \`createdBy\` \`createdBy\` char(36) NOT NULL`);
        ...
        await queryRunner.query(`ALTER TABLE \`callout\` ADD \`visibility\` varchar(128) NOT NULL`);
        ...
        await queryRunner.query(`ALTER TABLE \`calendar_event\` ADD \`type\` varchar(128) NOT NULL`);
        ...
        await queryRunner.query(`ALTER TABLE \`organization_verification\` DROP COLUMN \`status\``);
        await queryRunner.query(`ALTER TABLE \`organization_verification\` ADD \`status\` varchar(128) NOT NULL DEFAULT 'not-verified'`);
        ...
        await queryRunner.query(`ALTER TABLE \`credential\` ADD \`resourceID\` varchar(36) NOT NULL`);
        await queryRunner.query(`ALTER TABLE \`credential\` DROP COLUMN \`type\``);
        await queryRunner.query(`ALTER TABLE \`credential\` ADD \`type\` varchar(128) NOT NULL`);
        ...
        await queryRunner.query(`ALTER TABLE \`user\` ADD \`accountUpn\` varchar(128) NOT NULL`);
        await queryRunner.query(`ALTER TABLE \`user\` DROP COLUMN \`firstName\``);
        await queryRunner.query(`ALTER TABLE \`user\` ADD \`firstName\` varchar(128) NOT NULL`);
        await queryRunner.query(`ALTER TABLE \`user\` DROP COLUMN \`lastName\``);
        await queryRunner.query(`ALTER TABLE \`user\` ADD \`lastName\` varchar(128) NOT NULL`);
        await queryRunner.query(`ALTER TABLE \`user\` DROP COLUMN \`email\``);
        await queryRunner.query(`ALTER TABLE \`user\` ADD \`email\` varchar(512) NOT NULL`);
        await queryRunner.query(`ALTER TABLE \`user\` DROP COLUMN \`phone\``);
        await queryRunner.query(`ALTER TABLE \`user\` ADD \`phone\` varchar(128) NOT NULL`);
        ...
        await queryRunner.query(`ALTER TABLE \`invitation\` ADD \`contributorType\` varchar(128) NOT NULL`);
        ...
        await queryRunner.query(`ALTER TABLE \`platform_invitation\` ADD \`platformRole\` varchar(128) NULL`);
        await queryRunner.query(`ALTER TABLE \`platform_invitation\` DROP COLUMN \`email\``);
        await queryRunner.query(`ALTER TABLE \`platform_invitation\` ADD \`email\` varchar(128) NOT NULL`);
        await queryRunner.query(`ALTER TABLE \`platform_invitation\` DROP COLUMN \`firstName\``);
        await queryRunner.query(`ALTER TABLE \`platform_invitation\` ADD \`firstName\` varchar(128) NULL`);
        await queryRunner.query(`ALTER TABLE \`platform_invitation\` DROP COLUMN \`lastName\``);
        await queryRunner.query(`ALTER TABLE \`platform_invitation\` ADD \`lastName\` varchar(128) NULL`);
        ...
        await queryRunner.query(`ALTER TABLE \`space\` ADD \`levelZeroSpaceID\` varchar(36) NOT NULL`);
        await queryRunner.query(`ALTER TABLE \`space\` DROP COLUMN \`visibility\``);
        await queryRunner.query(`ALTER TABLE \`space\` ADD \`visibility\` varchar(128) NOT NULL`);
        ...
        await queryRunner.query(`ALTER TABLE \`space\` ADD UNIQUE INDEX \`IDX_43559aeadc1a5169d17e81b3d4\` (\`libraryId\`)`);
        await queryRunner.query(`ALTER TABLE \`space\` ADD UNIQUE INDEX \`IDX_6b1efee39d076d9f7ecb8fef4c\` (\`defaultsId\`)`);
        await queryRunner.query(`ALTER TABLE \`ai_persona\` DROP COLUMN \`dataAccessMode\``);
        await queryRunner.query(`ALTER TABLE \`ai_persona\` ADD \`dataAccessMode\` varchar(128) NOT NULL`);
        ...
        await queryRunner.query(`ALTER TABLE \`virtual_contributor\` ADD \`nameID\` varchar(36) NOT NULL`);
        await queryRunner.query(`ALTER TABLE \`virtual_contributor\` DROP COLUMN \`searchVisibility\``);
        await queryRunner.query(`ALTER TABLE \`virtual_contributor\` ADD \`searchVisibility\` varchar(128) NOT NULL`);
        ...
        await queryRunner.query(`ALTER TABLE \`innovation_hub\` ADD \`nameID\` varchar(36) NOT NULL`);
        ...
        await queryRunner.query(`ALTER TABLE \`innovation_hub\` ADD \`searchVisibility\` varchar(128) NOT NULL DEFAULT 'account'`);
        await queryRunner.query(`ALTER TABLE \`innovation_hub\` DROP COLUMN \`accountId\``);
        await queryRunner.query(`ALTER TABLE \`innovation_hub\` ADD \`accountId\` char(36) NULL`);
        ...
        await queryRunner.query(`ALTER TABLE \`activity\` ADD \`description\` varchar(512) NULL`);
        ...
        await queryRunner.query(`ALTER TABLE \`ai_persona_service\` ADD \`dataAccessMode\` varchar(128) NOT NULL`);
        await queryRunner.query(`ALTER TABLE \`ai_persona_service\` DROP COLUMN \`bodyOfKnowledgeType\``);
        await queryRunner.query(`ALTER TABLE \`ai_persona_service\` ADD \`bodyOfKnowledgeType\` varchar(128) NOT NULL`);
        await queryRunner.query(`ALTER TABLE \`ai_persona_service\` DROP COLUMN \`bodyOfKnowledgeID\``);
        await queryRunner.query(`ALTER TABLE \`ai_persona_service\` ADD \`bodyOfKnowledgeID\` varchar(128) NOT NULL`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`space\` CHANGE \`nameID\` \`nameID\` varchar(36) NULL`);
        ...
        await queryRunner.query(`ALTER TABLE \`discussion\` CHANGE \`nameID\` \`nameID\` varchar(36) NULL`);
        await queryRunner.query(`ALTER TABLE \`discussion\` ADD CONSTRAINT \`FK_2d8a3ca181c3f0346817685d21d\` FOREIGN KEY (\`profileId\`) REFERENCES \`profile\`(\`id\`) ON DELETE SET NULL ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE \`credential\` DROP COLUMN \`type\``);
        await queryRunner.query(`ALTER TABLE \`credential\` ADD \`type\` varchar(255) NOT NULL`);
        await queryRunner.query(`ALTER TABLE \`credential\` DROP COLUMN \`resourceID\``);
        ...
        await queryRunner.query(`ALTER TABLE \`organization_verification\` DROP COLUMN \`status\``);
        await queryRunner.query(`ALTER TABLE \`organization_verification\` ADD \`status\` varchar(255) NOT NULL DEFAULT 'not-verified'`);
        await queryRunner.query(`ALTER TABLE \`organization_verification\` DROP COLUMN \`organizationID\``);
