...
export class FixIndexesFKsRelations1728033222394 implements MigrationInterface {
  name = 'FixIndexesFKsRelations1728033222394';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE \`role_set\` ADD UNIQUE INDEX \`IDX_b038f74c8d4eadb839e78b99ce\` (\`authorizationId\`)`
    );
    await queryRunner.query(
      `ALTER TABLE \`role_set\` ADD UNIQUE INDEX \`IDX_00905b142498f63e76d38fb254\` (\`applicationFormId\`)`
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE \`template\` ADD UNIQUE INDEX \`IDX_4318f97beabd362a8a09e9d320\` (\`authorizationId\`)`
    );
    await queryRunner.query(
      `ALTER TABLE \`template\` ADD UNIQUE INDEX \`IDX_f58c3b144b6e010969e199beef\` (\`profileId\`)`
    );
    await queryRunner.query(
      `ALTER TABLE \`template\` ADD UNIQUE INDEX \`IDX_45cf273f30c1fa509456b6b0dd\` (\`innovationFlowId\`)`
    );
    await queryRunner.query(
      `ALTER TABLE \`template\` ADD UNIQUE INDEX \`IDX_eedeae5e63f9a9c3a0161541e9\` (\`communityGuidelinesId\`)`
    );
    await queryRunner.query(
      `ALTER TABLE \`template\` ADD UNIQUE INDEX \`IDX_c6e4d1a07781a809ad3b3ee826\` (\`calloutId\`)`
    );
    await queryRunner.query(
      `ALTER TABLE \`template\` ADD UNIQUE INDEX \`IDX_f09090a77e07377eefb3f731d9\` (\`whiteboardId\`)`
    );
    await queryRunner.query(
      `ALTER TABLE \`template\` ADD UNIQUE INDEX \`IDX_21fdaf6dc88bdd6e8839e29b0b\` (\`collaborationId\`)`
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE UNIQUE INDEX \`REL_b038f74c8d4eadb839e78b99ce\` ON \`role_set\` (\`authorizationId\`)`
    );
    await queryRunner.query(
      `CREATE UNIQUE INDEX \`REL_00905b142498f63e76d38fb254\` ON \`role_set\` (\`applicationFormId\`)`
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE UNIQUE INDEX \`REL_4318f97beabd362a8a09e9d320\` ON \`template\` (\`authorizationId\`)`
    );
    await queryRunner.query(
      `CREATE UNIQUE INDEX \`REL_f58c3b144b6e010969e199beef\` ON \`template\` (\`profileId\`)`
    );
    await queryRunner.query(
      `CREATE UNIQUE INDEX \`REL_45cf273f30c1fa509456b6b0dd\` ON \`template\` (\`innovationFlowId\`)`
    );
    await queryRunner.query(
      `CREATE UNIQUE INDEX \`REL_eedeae5e63f9a9c3a0161541e9\` ON \`template\` (\`communityGuidelinesId\`)`
    );
    await queryRunner.query(
      `CREATE UNIQUE INDEX \`REL_c6e4d1a07781a809ad3b3ee826\` ON \`template\` (\`calloutId\`)`
    );
    await queryRunner.query(
      `CREATE UNIQUE INDEX \`REL_f09090a77e07377eefb3f731d9\` ON \`template\` (\`whiteboardId\`)`
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE \`template\` DROP INDEX \`IDX_21fdaf6dc88bdd6e8839e29b0b\``
    );
    await queryRunner.query(
      `ALTER TABLE \`template\` DROP INDEX \`IDX_f09090a77e07377eefb3f731d9\``
    );
    await queryRunner.query(
      `ALTER TABLE \`template\` DROP INDEX \`IDX_c6e4d1a07781a809ad3b3ee826\``
    );
    await queryRunner.query(
      `ALTER TABLE \`template\` DROP INDEX \`IDX_eedeae5e63f9a9c3a0161541e9\``
    );
    await queryRunner.query(
      `ALTER TABLE \`template\` DROP INDEX \`IDX_45cf273f30c1fa509456b6b0dd\``
    );
    await queryRunner.query(
      `ALTER TABLE \`template\` DROP INDEX \`IDX_f58c3b144b6e010969e199beef\``
    );
    await queryRunner.query(
      `ALTER TABLE \`template\` DROP INDEX \`IDX_4318f97beabd362a8a09e9d320\``
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE \`role_set\` DROP INDEX \`IDX_00905b142498f63e76d38fb254\``
    );
    await queryRunner.query(
      `ALTER TABLE \`role_set\` DROP INDEX \`IDX_b038f74c8d4eadb839e78b99ce\``
    );
    await queryRunner.query(
