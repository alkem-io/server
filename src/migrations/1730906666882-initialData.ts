    ...
    await queryRunner.query(
      `INSERT INTO preference_definition (id, version, groupName, displayName, description, valueType, type, definitionSet)
       VALUES
         ...
         ('${preferenceDefinitionIds[25]}',1,'Notification','New Post created','Receive notification when a Post is created in community i am a member of','boolean','NotificationPostCreated','user'),
