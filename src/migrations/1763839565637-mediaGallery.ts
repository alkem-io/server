...
export class MediaGallery1763839565637 implements MigrationInterface {
  name = 'MediaGallery1763839565637';

  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      'CREATE TABLE `media_gallery` (`id` char(36) NOT NULL, `createdDate` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), `updatedDate` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), `version` int NOT NULL, `nameID` varchar(36) NOT NULL, `createdBy` char(36) NULL, `authorizationId` char(36) NULL, `profileId` char(36) NULL, UNIQUE INDEX `REL_e0ee9bf6142bc19e9eff263824` (`authorizationId`), UNIQUE INDEX `REL_f3d9636c2b8b9d056a1de2cc66` (`profileId`), PRIMARY KEY (`id`)) ENGINE=InnoDB'
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      'ALTER TABLE `media_gallery` DROP FOREIGN KEY `FK_f3d9636c2b8b9d056a1de2cc66c`'
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      'DROP INDEX `REL_f3d9636c2b8b9d056a1de2cc66` ON `media_gallery`'
    );
    await queryRunner.query(
