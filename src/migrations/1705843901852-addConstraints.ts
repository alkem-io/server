...
export class addConstraints1705843901852 implements MigrationInterface {
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `DROP INDEX \`FK_55333901817dd09d5906537e088\` ON \`platform\``
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `DROP INDEX \`FK_5554d59c0b805c9c1ecb0070e16\` ON \`platform\``
    );
    await queryRunner.query(
    ...
    // this one was missing in the first place
    await queryRunner.query(
    ...
    await queryRunner.query(
      `DROP INDEX \`FK_6664d59c0b805c9c1ecb0070e16\` ON \`library\``
    );
    await queryRunner.query(
    ...
    // CREATED BY
    await queryRunner.query(
      `ALTER TABLE \`discussion\` ADD UNIQUE INDEX \`IDX_3d196d93816b91fdbec87363e9\` (\`createdBy\`)`
    );
    await queryRunner.query(
      `CREATE UNIQUE INDEX \`REL_3d196d93816b91fdbec87363e9\` ON \`discussion\` (\`createdBy\`)`
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE \`invitation\` ADD UNIQUE INDEX \`IDX_82cb26926bb13032087af2b116\` (\`createdBy\`)`
    );
    await queryRunner.query(
      `CREATE UNIQUE INDEX \`REL_82cb26926bb13032087af2b116\` ON \`invitation\` (\`createdBy\`)`
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE \`invitation_external\` ADD UNIQUE INDEX \`IDX_ad65b2c0423314a193dd019de1\` (\`createdBy\`)`
    );
    await queryRunner.query(
      `CREATE UNIQUE INDEX \`REL_ad65b2c0423314a193dd019de1\` ON \`invitation_external\` (\`createdBy\`)`
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE \`document\` ADD UNIQUE INDEX \`IDX_a581782d3fe36e6cb98e40b057\` (\`createdBy\`)`
    );
    await queryRunner.query(
      `CREATE UNIQUE INDEX \`REL_a581782d3fe36e6cb98e40b057\` ON \`document\` (\`createdBy\`)`
    );
    // foreign key already exists - FK_3337f26ca267009fcf514e0e726

    await queryRunner.query(
      `ALTER TABLE \`whiteboard\` ADD UNIQUE INDEX \`IDX_655eca3595b132e412abe527e8\` (\`createdBy\`)`
    );
    await queryRunner.query(
      `CREATE UNIQUE INDEX \`REL_655eca3595b132e412abe527e8\` ON \`whiteboard\` (\`createdBy\`)`
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE \`whiteboard_rt\` ADD UNIQUE INDEX \`IDX_93754d87bcb9acafb8b84d63b3\` (\`createdBy\`)`
    );
    await queryRunner.query(
      `CREATE UNIQUE INDEX \`REL_93754d87bcb9acafb8b84d63b3\` ON \`whiteboard_rt\` (\`createdBy\`)`
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE \`post\` ADD UNIQUE INDEX \`IDX_43ae5b59527654c45cc0355324\` (\`createdBy\`)`
    );
    await queryRunner.query(
      `CREATE UNIQUE INDEX \`REL_43ae5b59527654c45cc0355324\` ON \`post\` (\`createdBy\`)`
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE \`callout_contribution\` ADD UNIQUE INDEX \`IDX_f09c22f8f0f52a6744dfedc0b5\` (\`createdBy\`)`
    );
    await queryRunner.query(
      `CREATE UNIQUE INDEX \`REL_f09c22f8f0f52a6744dfedc0b5\` ON \`callout_contribution\` (\`createdBy\`)`
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE \`callout\` ADD UNIQUE INDEX \`IDX_ae73f8cd48086a99e15ff0be2e\` (\`createdBy\`)`
    );
    await queryRunner.query(
      `CREATE UNIQUE INDEX \`REL_ae73f8cd48086a99e15ff0be2e\` ON \`callout\` (\`createdBy\`)`
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE \`calendar_event\` ADD UNIQUE INDEX \`IDX_49e7be00075627c834561a6cf6\` (\`createdBy\`)`
    );
    await queryRunner.query(
      `CREATE UNIQUE INDEX \`REL_49e7be00075627c834561a6cf6\` ON \`calendar_event\` (\`createdBy\`)`
    );
