...
export class CommunityPolls1772569123375 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`CREATE TABLE "poll_vote" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "createdDate" TIMESTAMP NOT NULL DEFAULT now(), "updatedDate" TIMESTAMP NOT NULL DEFAULT now(), "version" integer NOT NULL, "createdBy" uuid NOT NULL, "selectedOptionIds" jsonb NOT NULL, "pollId" uuid NOT NULL, CONSTRAINT "UQ_c3a1e0d8319f92349a8eafc4d5f" UNIQUE ("createdBy", "pollId"), CONSTRAINT "PK_fd002d371201c472490ba89c6a0" PRIMARY KEY ("id"))`);
