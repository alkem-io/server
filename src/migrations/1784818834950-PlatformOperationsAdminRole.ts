...
/**
 * workspace#032-platform-ops-admin-role (Platform Operations Admin): registers the
 ...
 */
export class PlatformOperationsAdminRole1784818834950
  implements MigrationInterface
{
  name = 'PlatformOperationsAdminRole1784818834950';
