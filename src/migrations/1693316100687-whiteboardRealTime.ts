...
export class whiteboardRealTime1693316100687 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      'CREATE TABLE `whiteboard_rt` (`id` char(36) NOT NULL, `createdDate` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), `updatedDate` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), `version` int NOT NULL, `nameID` varchar(255) NOT NULL, `value` longtext NOT NULL, `createdBy` char(36) NULL, `authorizationId` char(36) NULL, `profileId` char(36) NULL, `calloutId` char(36) NULL, UNIQUE INDEX `REL_60e34af57347a7d391bc598568` (`authorizationId`), UNIQUE INDEX `REL_9dd2273a4105bd6ed536fe4913` (`profileId`), PRIMARY KEY (`id`)) ENGINE=InnoDB'
    );
    await queryRunner.query(
