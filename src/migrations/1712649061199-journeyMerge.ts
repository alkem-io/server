...
export class journeyMerge1712649061199 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    const challenges: any[] =
      await queryRunner.query(`SELECT id, createdDate, updatedDate,
    ...
    for (const challenge of challenges) {
      await queryRunner.query(`INSERT INTO space (id, createdDate, updatedDate,
                                          version, nameID, authorizationID,
                                          contextId, communityId, agentId,
                                          spaceId, collaborationId, profileId,
                                          storageAggregatorId, accountId, type,
                                          settingsStr, level)
                                          VALUES (
                                            '${challenge.id}', '${challenge.createdDate}', '${challenge.updatedDate}',
    ...
    for (const opportunity of opportunities) {
      await queryRunner.query(`INSERT INTO space (id, createdDate, updatedDate,
                                          ...
                                          settingsStr, level)
                                          VALUES (
                                            '${opportunity.id}', '${opportunity.createdDate}', '${opportunity.updatedDate}',
