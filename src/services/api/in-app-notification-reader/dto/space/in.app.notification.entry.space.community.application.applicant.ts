...
import { InAppNotificationSpaceCommunityApplicationApplicantPayload } from '@services/adapters/notification-in-app-adapter/dto/space/notification.in.app.space.community.application.applicant.payload';
