...
import { InAppNotificationSpaceCommunicationMessageSenderPayload } from '@platform/in-app-notification/dto/space/notification.in.app.space.communication.message.sender.payload';
