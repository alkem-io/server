...
import { InAppNotificationPayloadSpaceCommunityNewMember } from '../../dto/space/in.app.notification.entry.space.community.new.member';
...
@Resolver(() => InAppNotificationPayloadSpaceCommunityNewMember)
export class InAppNotificationSpaceCommunityNewMemberResolverFields {
  ...
  public contributorType(
    @Parent() payload: InAppNotificationPayloadSpaceCommunityNewMember
  ) {
