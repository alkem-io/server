...
import { InAppNotificationEntrySpaceCommunityNewMemberAdmin } from '../../dto/space/in.app.notification.entry.space.community.new.member.admin';
...
@Resolver(() => InAppNotificationEntrySpaceCommunityNewMemberAdmin)
export class InAppNotificationSpaceCommunityNewMemberAdminResolverFields {
  @ResolveField(() => RoleSetContributorType, {
    nullable: false,
    description: 'The type of the Contributor that joined.',
  })
  public contributorType(
    @Parent() { payload }: InAppNotificationEntrySpaceCommunityNewMemberAdmin
  ) {
