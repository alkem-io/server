...
import { InAppNotificationEntrySpaceCommunicationMessageRecipient } from '../../dto/space/in.app.notification.entry.space.communication.message.recipient';
...
@Resolver(() => InAppNotificationEntrySpaceCommunicationMessageRecipient)
export class InAppNotificationSpaceCommunicationMessageRecipientResolverFields {
  ...
  public contributor(
    @Parent()
    { payload }: InAppNotificationEntrySpaceCommunicationMessageRecipient,
