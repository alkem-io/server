...
import { InAppNotificationEntrySpaceCommunicationUpdateAdmin } from '../../dto/space/in.app.notification.entry.space.communication.update.admin';
...
@Resolver(() => InAppNotificationEntrySpaceCommunicationUpdateAdmin)
export class InAppNotificationSpaceCommunicationUpdateAdminResolverFields {
  ...
  public contributor(
    @Parent()
    { payload }: InAppNotificationEntrySpaceCommunicationUpdateAdmin,
