...
import { InAppNotificationEntrySpaceCommunicationMessageSender } from '../../dto/space/in.app.notification.entry.space.communication.message.sender';
...
@Resolver(() => InAppNotificationEntrySpaceCommunicationMessageSender)
export class InAppNotificationSpaceCommunicationMessageSenderResolverFields {
  ...
  public contributor(
    @Parent()
    { payload }: InAppNotificationEntrySpaceCommunicationMessageSender,
