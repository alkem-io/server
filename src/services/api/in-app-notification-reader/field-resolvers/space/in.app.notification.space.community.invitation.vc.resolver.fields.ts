...
import { InAppNotificationEntrySpaceCommunityInvitationVc } from '../../dto/space/in.app.notification.entry.space.community.invitation.vc';
...
@Resolver(() => InAppNotificationEntrySpaceCommunityInvitationVc)
export class InAppNotificationSpaceCommunityInvitationVcResolverFields {
  ...
  public contributor(
    @Parent()
    { payload }: InAppNotificationEntrySpaceCommunityInvitationVc,
