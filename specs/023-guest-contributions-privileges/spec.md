...
**Feature Branch**: `023-guest-contributions-privileges`
**Created**: 2025-11-05
**Status**: Draft
...
- The allowGuestContributions setting already exists in SpaceSettingsCollaboration (implemented in spec 022-guest-contributions-policy).
...
- **Spec 022-guest-contributions-policy**: Provides the allowGuestContributions setting infrastructure that this feature extends.
