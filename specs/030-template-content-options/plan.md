...
**Branch**: `030-template-content-options` | **Date**: 2026-01-15 | **Spec**: [spec.md](./spec.md)
**Input**: Feature specification from `/specs/030-template-content-options/spec.md`
...
```text
specs/030-template-content-options/
