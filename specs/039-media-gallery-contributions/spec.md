...
- **FR-004**: The contribution reporter service MUST expose a `mediaGalleryContribution` method following the same signature pattern as `whiteboardContribution` and `memoContribution` (accepting contribution details and author details).
