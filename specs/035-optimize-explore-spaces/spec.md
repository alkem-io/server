...
**\*** Total SQL queries were measured against the local dev dataset (~7 spaces). The credential-lookup count of 60 is the theoretical projection for the default 30-space limit (30 spaces × 2 queries each). At the dev dataset scale, credential lookups are a subset of the 34 total.
