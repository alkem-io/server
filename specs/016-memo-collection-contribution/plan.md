...
**Branch**: `016-memo-collection-contribution` | **Date**: 2025-11-06 | **Spec**: [spec.md](./spec.md)
**Input**: Feature specification from `/specs/016-memo-collection-contribution/spec.md`
...
```text
specs/016-memo-collection-contribution/
