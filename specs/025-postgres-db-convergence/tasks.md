...
- [x] T008 [US1] Define Alkemio Postgres baseline migration strategy in `specs/025-postgres-db-convergence/plan.md` (update if needed).
...
- [x] T013 [US1] Add quickstart section for Postgres-only Alkemio + Kratos deployment in `specs/025-postgres-db-convergence/quickstart.md` (update if needed).
...
- [x] T017 [US2] Design CSV export/import mapping for core entities in `specs/025-postgres-db-convergence/data-model.md` (update with concrete mappings).
...
- [x] T026 [US2] Extend `specs/025-postgres-db-convergence/quickstart.md` with end-to-end CSV pipeline steps.
...
- [x] T028 [P] [US3] Create migration verification checklist (auth, spaces, content, authorization) in `specs/025-postgres-db-convergence/quickstart.md` or a new `verification-checklist.md` in the same folder.
...
- [x] T031 [US3] Update `specs/025-postgres-db-convergence/spec.md` success criteria section with rehearsal/rollback details as implemented.
