...
**Branch**: `025-postgres-db-convergence` | **Date**: 2025-11-20 | **Spec**: `specs/025-postgres-db-convergence/spec.md`
**Input**: Feature specification from `/specs/025-postgres-db-convergence/spec.md`
...
specs/025-postgres-db-convergence/
├── spec.md
├── plan.md
├── research.md
├── data-model.md
