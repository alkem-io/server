...
import { IActorBase } from './actor.interface';
...
export abstract class Actor extends AuthorizableEntity implements IActorBase {
...
export interface IActorBase extends IAuthorizable {
  type: ActorType;
