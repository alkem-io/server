...
**Feature Branch**: `026-actor-transformation`
**Created**: 2025-12-27
**Status**: Draft
...
- **FR-002**: System MUST support five ActorTypes: USER, ORGANIZATION, VIRTUAL_CONTRIBUTOR, SPACE, ACCOUNT
...
- **FR-010**: System MUST expose IActor interface in GraphQL with fields: id, type, credentials, authorization, profile (nullable)
- **FR-011**: System MUST provide actor(id) query that returns IActor with proper type resolution
- **FR-012**: System MUST provide actorsWithCredential query for polymorphic credential lookups
- **FR-013**: User, Organization, VirtualContributor, Space, Account types MUST implement IActor interface
