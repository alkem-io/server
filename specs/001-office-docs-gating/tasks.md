...
- [ ] T005 [P] Create input DTOs: `CreateOfficeDocumentInput` (`calloutID: UUID!`, `profileData: CreateProfileInput!`, `contentUpdatePolicy?: ContentUpdatePolicy`), `UpdateOfficeDocumentInput` (`ID: UUID!`, `profileData?: UpdateProfileInput`), `DeleteOfficeDocumentInput` (`ID: UUID!`) — `src/domain/common/office-document/dto/`
