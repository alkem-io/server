...
**Input**: Design documents from `/specs/019-notification-email-blacklist/`
...
- [ ] T001 Align GraphQL contract additions for add/remove operations and integration field description in `specs/019-notification-email-blacklist/contracts/notification-email-blacklist.graphql`.
...
- [ ] T014 Refresh the step-by-step instructions in `specs/019-notification-email-blacklist/quickstart.md` with the final mutation/query names and variables.
