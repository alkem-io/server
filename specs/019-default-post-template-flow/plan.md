...
**Branch**: `019-default-post-template-flow` | **Date**: 2026-01-08 | **Spec**: [spec.md](./spec.md)
**Input**: Feature specification from `/specs/019-default-post-template-flow/spec.md`
