...
**Branch**: `017-postgres-db-convergence` | **Date**: 2025-11-20 | **Spec**: `specs/017-postgres-db-convergence/spec.md`
**Input**: Feature specification from `/specs/017-postgres-db-convergence/spec.md`
...
**Structure Decision**: Single backend server (`src/**` + `test/**`) with domain-centric modules. This feature will primarily touch migrations/configuration, possible domain repositories/services, and documentation under `docs/` and `specs/017-postgres-db-convergence/`.
