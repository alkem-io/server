...
**Branch**: `031-vitest-migration` | **Date**: 2026-01-18 | **Spec**: [spec.md](./spec.md)
**Input**: Feature specification from `/specs/031-vitest-migration/spec.md`
...
|----------|--------|------|
| research.md | ✅ Complete | `specs/031-vitest-migration/research.md` |
| data-model.md | ✅ Complete | `specs/031-vitest-migration/data-model.md` |
| quickstart.md | ✅ Complete | `specs/031-vitest-migration/quickstart.md` |
| contracts/ | ✅ Complete | `specs/031-vitest-migration/contracts/` |
