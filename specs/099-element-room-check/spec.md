...
- **FR-003**: The platform MUST resolve the creator and every member identifier to known Alkemio actors (any subtype permitted by FR-019 — User, VirtualContributor, Organization, Space, Account). If any identifier cannot be resolved, the platform MUST reply "deny" with a human-readable reason indicating the actor was not found.
