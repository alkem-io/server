...
**Branch**: `029-default-post-template-flow`
...
- [x] T020 [P] [US3] Create example GraphQL queries showing frontend integration in specs/029-default-post-template-flow/contracts/example-queries.graphql
