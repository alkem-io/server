...
**Feature**: 029-default-post-template-flow
**Date**: 2026-01-08
...
- Branch `029-default-post-template-flow` checked out
...
Refs: #029-default-post-template-flow"
```

**Push branch**:

```bash
git push -u origin 029-default-post-template-flow
```
...
5. Reference spec in PR description: `specs/029-default-post-template-flow/spec.md`
...
| `specs/029-default-post-template-flow/`                                           | Feature documentation |
