...
**Feature Branch**: `014-oidc-golang-service`
**Created**: October 29, 2025
**Status**: Draft
**Input**: User description: "Separate the OIDC controller (from 013-synapse-kratos-oidc) into a new standalone service written in Golang, fully configurable through environment variables."
