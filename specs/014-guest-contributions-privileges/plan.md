...
**Branch**: `014-guest-contributions-privileges` | **Date**: 2025-11-05 | **Spec**: [spec.md](./spec.md)
**Input**: Feature specification from `/specs/014-guest-contributions-privileges/spec.md`
...
```text
specs/014-guest-contributions-privileges/
