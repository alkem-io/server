...
**Branch**: `021-toggle-whiteboard-guest` | **Date**: 2025-11-17 | **Spec**: [Feature Specification](./spec.md)
**Input**: Feature specification from `/specs/021-toggle-whiteboard-guest/spec.md`
...
```text
specs/021-toggle-whiteboard-guest/
├── plan.md
├── research.md
├── data-model.md
├── quickstart.md
