...
- **Documentation**: `docs/Developing.md`, `docs/Running.md`, `docs/authentication/authentication_flow.md`, and `specs/013-synapse-kratos-oidc/quickstart.md` refreshed with Hydra/Synapse flow, troubleshooting and env guidance.
...
- **Operations**: Troubleshooting catalogue, env variable reference, and health-check commands consolidated in `specs/013-synapse-kratos-oidc/quickstart.md`.
