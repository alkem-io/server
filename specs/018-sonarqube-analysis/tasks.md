...
**Input**: Design documents from `/specs/018-sonarqube-analysis/`
...
- [x] T003 Document required CI secrets for SonarQube (token, project key) in specs/018-sonarqube-analysis/quickstart.md
...
- [x] T008 Update specs/018-sonarqube-analysis/quickstart.md with final secret names and SonarQube project URL
...
- [x] T018 [US2] Add a short "How to read SonarQube dashboards" note to `specs/018-sonarqube-analysis/quickstart.md` for release managers
...
- [x] T020 [P] [US3] Document the SonarQube token rotation procedure in `specs/018-sonarqube-analysis/quickstart.md` (including where to update CI secrets)
...
- [x] T027 [P] Add a short troubleshooting section to `specs/018-sonarqube-analysis/quickstart.md` for common SonarQube CI issues
